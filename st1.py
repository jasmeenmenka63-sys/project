...
if menu=="🏠 Overview":
    ...
    st.markdown("<div style='background:#0F172A;border:3px solid #2563EB;padding:28px;border-radius:18px;text-align:center;box-shadow:0 8px 18px rgba(0,0,0,0.25);margin-bottom:25px;'><h1 style='color:white;margin:0;font-size:40px;font-weight:bold;'>📚 Indian School Performance Analysis</h1><p style='color:#E2E8F0;font-size:19px;margin-top:12px;'>An Interactive Dashboard for Analyzing Dropout Rates, Gross Enrollment Ratio and School Infrastructure Across India</p></div>",unsafe_allow_html=True)
